...
class TestCloudBuilderApiClient:
    ...
    def set_module_args(self, args):
        """Prepare arguments for the Ansible module."""
        basic.AnsibleModule.params = args
    ...
    @patch('ansible_collections.vmware.vcf.plugins.modules.cloud_builder_create_management_domain')
